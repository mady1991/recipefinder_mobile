...
const SearchScreen = () => {
  ...
  const performSearch = async (query) => {
    ...
    if (results.length === 0) {
      const ingredientResults = await MealAPI.filter(query);
  ...
  //calling this once data changes 
  useEffect(() => {
  ...
  if (initialLoading) return <LoadingSpinner message='Loading recipe...'/>;
  return (
    <View style={searchStyles.container}>
      ...
      <View style={searchStyles.resultsSection}>
        ...
        {loading ? (<LoadingSpinner message='Loading recipe...'/>) : (
          <FlatList
            data={recipes}
